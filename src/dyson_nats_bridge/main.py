...
from .device import DysonBridge
...
async def _amain() -> int:
    ...
    tracing.configure(settings, service_name="dyson-nats-bridge")
    ...
    def is_healthy() -> bool:
        ...
        # fan should page via the dyson_connected metric, not restart-loop the pod.
